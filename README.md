...
7. **Internal Network Pivoting / Lateral Movement**
   Provides a proxy option. When enabled, a SOCKS proxy will be started on a random local port, allowing further access to devices within the target internal network.
---
...
![alt text](./pic/map4.png)

![alt text](./pic/map5.png)

![alt text](./pic/map6.png)
...
icacls .\id_rsa /grant:r "%COMPUTERNAME%\%USERNAME%:(R,W)" /c /q
```
